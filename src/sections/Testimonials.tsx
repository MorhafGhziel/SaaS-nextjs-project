...
const TestimonialsColumn = (props: { className?: String; testimonials: typeof testimonials }) => (
        ...
        <div>{props.testimonials .map(({text, imageSrc, name, username}) => (
          <div className="card mt-5">
            <div>{text}</div>
              <div className="flex items-center gap-2 mt-5">
                <div className="flex items-center gap-3 mt-5">
                <Image src={imageSrc} width={40} height={40} alt={imageSrc} className="h-10 w-10 rounded-full" />
                <div className="flex flex-col">
                  <div className="font-bold leading-5 tracking-tight">{name}</div>
